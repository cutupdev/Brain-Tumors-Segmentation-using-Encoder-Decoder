...
# model.py
#
# Created by Scott Lee on 10/27/20. Ported from https://github.com/IAmSuyogJadhav/3d-mri-brain-tumor-segmentation-using-autoencoder-regularization/raw/master/model.py.
#

'''
Description:
Keras models for BraTS datasets (2018).
'''
