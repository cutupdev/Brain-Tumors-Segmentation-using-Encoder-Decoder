...
# model.py
#
# Created by Scott Lee on 11/14/20. Ported from https://github.com/IAmSuyogJadhav/3d-mri-brain-tumor-segmentation-using-autoencoder-regularization/raw/master/model.py.
#

'''
Description:
Autoencoder-decoder network designed to reconstruct missing modes when not present.
'''
...
def build_model(input_shape=(4, 160, 192, 128), output_channels=4, weight_L2=0.1, weight_KL=0.1, dice_e=1e-8, input_dropout_rate=0.5):
    """
    build_model_ae(input_shape=(4, 160, 192, 128), output_channels=4, weight_L2=0.1, weight_KL=0.1)
    -------------------------------------------
